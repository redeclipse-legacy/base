                ...
                uicenterlist(g, {
                    ...
                    uicenter(g, {
                        ...
                        uicenterlist(g, uicenterlist(g, {
                            ...
                            {
                                float ratio = game::player1.frags >= game::player1.deaths ? (game::player1.frags/float(ax(game::player1.deaths, 1))) : -(game::player1.deaths/float(max(game::player1.frags, 1)));
